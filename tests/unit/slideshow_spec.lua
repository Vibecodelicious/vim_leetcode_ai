...
describe('slideshow', function()
  ...
  describe('navigation', function()
    ...
    describe('parse_char()', function()
      it('should parse n as next', function()
        local cmd = navigation.parse_char('n')
        assert.equals('next', cmd)
      end)

      it('should parse j as next', function()
        local cmd = navigation.parse_char('j')
        assert.equals('next', cmd)
      end)

      it('should parse space as next', function()
        local cmd = navigation.parse_char(' ')
        assert.equals('next', cmd)
      end)

      it('should parse p as prev', function()
        local cmd = navigation.parse_char('p')
        assert.equals('prev', cmd)
      end)

      it('should parse k as prev', function()
        local cmd = navigation.parse_char('k')
        assert.equals('prev', cmd)
      end)

      it('should parse q as quit', function()
        local cmd = navigation.parse_char('q')
        assert.equals('quit', cmd)
      end)

      it('should parse digit as goto', function()
        local cmd, arg = navigation.parse_char('5')
        assert.equals('goto', cmd)
        assert.equals(5, arg)
      end)

      it('should return nil for unknown char', function()
        local cmd = navigation.parse_char('x')
        assert.is_nil(cmd)
      end)
    end)
  end)
