...
CRITICAL: After launching a slideshow, output EXACTLY this message (nothing more):
"Slideshow launched! Navigate with :cnext and :cprev. Use :copen to see all slides."
